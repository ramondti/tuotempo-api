  ...
  console.log(cancellation_reason)
    ...
    const dados = {
      ...
      availability: {
        ...
        location_lid: result[0].LOCATION_LID,
        resource_lid: result[0].RESOURCE_LID,
        activity_lid: null,
        insurance_lid: result[0].INSURANCE_LID,
      },
      user: {
        user_lid: result[0].USER_LID,
        id_number: {
          number: result[0].ID_UMBER,
